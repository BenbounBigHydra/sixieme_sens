<template>
  <div class="min-h-screen bg-[#2D2144] bg-cover bg-center flex flex-col justify-between" style="background-image: url('/images/Background-Space.png');">
    ...
    <div v-if="currentState === 'landing'" class="p-8 md:p-12 lg:p-16 h-full flex flex-col justify-between flex-grow">
      <div>
        ...
        <div class="mt-16 md:mt-24 max-w-xl">
          ...
          <button @click="startQuiz" class="inline-block border-[2px] border-[#b3d9ff] px-6 md:px-8 py-3 md:py-4 text-[#fffbf1] font-inter text-base md:text-lg hover:bg-[#fffbf1]/10 transition-colors mb-6">
            Commencer le quizz
          </button>
    ...
    <div v-else-if="currentState === 'quiz'" class="p-8 md:p-12 lg:p-16 h-full flex flex-col justify-between flex-grow">
      ...
      <div class="mt-28 md:mt-36 max-w-2xl flex-grow flex flex-col justify-center">
        <h2 class="font-jersey text-[28px] md:text-[40px] text-[#fffbf1] leading-tight mb-10 whitespace-pre-line relative z-10">
        ...
        <div class="flex gap-6">
          <button @click="answerQuestion('Oui')" class="flex-1 max-w-[200px] border-[2px] border-[#b3d9ff] px-6 py-4 text-[#fffbf1] font-inter text-lg hover:bg-[#fffbf1]/10 transition-colors">
            Oui
          </button>
          <button @click="answerQuestion('Non')" class="flex-1 max-w-[200px] border-[2px] border-[#b3d9ff] px-6 py-4 text-[#fffbf1] font-inter text-lg hover:bg-[#fffbf1]/10 transition-colors">
            Non
          </button>
        </div>
      </div>
    ...
    <!-- INELIGIBLE STATE -->
    <div v-else-if="currentState === 'ineligible'" class="p-8 md:p-12 lg:p-16 h-full flex flex-col justify-center flex-grow">
      <div class="max-w-2xl">
        ...
        <div class="flex flex-col sm:flex-row gap-6">
          <button @click="continueQuiz" class="border-[2px] border-[#b3d9ff] px-8 py-4 text-[#fffbf1] font-inter text-lg hover:bg-[#fffbf1]/10 transition-colors text-center">
            Continuer le quizz
          </button>
          <a :href="homeLink" class="border-[2px] border-[#b3d9ff] px-8 py-4 text-[#fffbf1] font-inter text-lg hover:bg-[#fffbf1]/10 transition-colors text-center inline-block">
    ...
    <div v-else-if="currentState === 'success'" class="p-8 md:p-12 lg:p-16 h-full flex flex-col flex-grow">
      ...
      <div class="mt-16 md:mt-24 max-w-2xl flex-grow flex flex-col justify-center">
        ...
        <div>
          <a href="#" class="inline-block border-[2px] border-[#b3d9ff] px-8 py-4 text-[#fffbf1] font-inter text-lg hover:bg-[#fffbf1]/10 transition-colors">
            Prendre rendez-vous
          </a>
        </div>
      </div>
