                    ...
                    <div
                        ...
                        <div class="flex items-center cursor-pointer group" @click="sortBy('name')">
                            ...
                            <img src="/images/BlueChevron Down.svg" alt="Sort" class="h-4 w-4 transition-transform"
                                :class="{ 'rotate-180': sortKey === 'name' && sortOrder === 'asc' }" />
                        </div>
                        ...
                        <div class="flex items-center cursor-pointer group" @click="sortBy('participation')">
                            ...
                            <div class="relative group-info cursor-default flex items-center mr-2" @click.stop>
                                <img src="/images/info.svg" alt="Info" class="h-4 w-4" style="filter: brightness(0);" />
                                <div
                                    class="absolute left-0 top-full mt-2 w-[300px] bg-[#fffbf1] border border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] p-4 hidden group-hover:block z-50">
                                    <p class="font-jersey text-[20px] text-black leading-tight">Taux calculé sur l'année
                                        en cours.</p>
                                    <p class="font-inter text-[14px] text-black mt-2">Ce taux correspond au ratio entre
                                        le nombre de poches de sang récoltées et le nombre total d'employés.</p>
                                </div>
                            </div>
                            <img src="/images/BlueChevron Down.svg" alt="Sort" class="h-4 w-4 transition-transform"
                                :class="{ 'rotate-180': sortKey === 'participation' && sortOrder === 'asc' }" />
                        </div>
                            ...
                            <div class="relative group-info cursor-default flex items-center mr-2" @click.stop>
                                ...
                                <div
                                    ...
                                    <p class="font-jersey text-[20px] text-black leading-tight">Taux calculé sur l'année
                                        en cours.</p>
                                    <p class="font-inter text-[14px] text-black mt-2">Ce taux correspond au ratio entre
                                        le nombre de poches de sang récoltées et le nombre de personnes inscrites à la
                                        collecte.</p>
                                </div>
                            </div>
                            <img src="/images/BlueChevron Down.svg" alt="Sort" class="h-4 w-4 transition-transform"
                                :class="{ 'rotate-180': sortKey === 'rigueur' && sortOrder === 'asc' }" />
                        </div>
                            ...
                            <div v-for="(company, index) in filteredAndSortedCompanies" :key="company.id"
                                ...
                                <div class="flex items-center space-x-3">
                                    <div class="h-8 w-16 flex items-center justify-start">
                                        <img :src="company.logo ? '/' + company.logo : '/images/BCGE.png'" alt="Logo"
                                            class="max-h-full max-w-full object-contain" />
                                    </div>
                                    <span class="font-inter font-bold text-lg md:text-sm text-[#393939]">{{ company.name
                                    }}</span>
                                </div>
                                ...
                                <div class="flex items-center justify-between md:justify-start w-full md:w-auto">
                                    ...
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <div
                                            ...
                                            {{ company.collections?.past || 0 }}</div>
                                    </div>
                                </div>

                                <!-- Participation -->
                                <div
                                    class="font-inter text-sm text-[#393939] flex justify-between md:block w-full md:w-auto">
                                    <span class="md:hidden font-bold">Participation:</span>
                                    <span>{{ company.participation !== undefined ? (company.participation *
                                ...
                                <div
                                    ...
                                    <span>{{ company.rigueur !== undefined ? (company.rigueur * 100).toFixed(0) + '%' :
                                        '0%' }}</span>
                                </div>
            ...
            <div
                ...
                <div class="p-6 space-y-5 overflow-y-auto">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div class="space-y-5">
                            ...
                            <!-- Couleur -->
                            <div>
                                <label class="block font-inter text-sm font-bold text-[#393939] mb-2">Couleur de la
                                    marque</label>
                                <div class="flex items-center space-x-3">
                ...
                <div class="flex justify-end items-center p-6 border-t border-blue-200 bg-gray-50/50 space-x-4">
                    <button @click="closeModal"
                        class="font-inter text-sm font-bold text-gray-600 hover:text-black transition-colors">
                        Annuler
                    </button>
