        ...
        <section class="max-w-desktop mx-auto px-8 md:px-16 lg:px-24 xl:px-32 2xl:px-40 pt-12 pb-20">
            ...
            <div class="flex flex-col items-center md:items-start text-center md:text-left mb-10">
                <img src="/images/YellowSquares.png" alt="Squares"
                    class="h-6 w-auto object-contain mb-6 origin-center md:origin-left" />
                <h1
                    class="font-['Jersey_20'] text-[48px] md:text-[64px] leading-[1.1] font-normal text-black mb-4 tracking-wide">
            ...
            <div v-if="isSubmitted"
                class="bg-[#caefb2] text-black font-['Inter'] px-6 py-4 flex items-center gap-4 mb-8 w-full">
                <img src="/images/BlackCheck.svg" alt="Check" class="w-6 h-6 flex-shrink-0" />
                <span class="text-base md:text-lg font-bold">Merci pour votre demande ! Nous vous contacterons au plus
                    vite.</span>
            </div>
            ...
            <form v-else @submit.prevent="submitForm" class="w-full font-['Inter'] text-black flex flex-col gap-6">
                ...
                <div class="flex flex-col md:flex-row gap-6 md:gap-12">
                    ...
                    <div class="flex-1 flex flex-col gap-2">
                        ...
                        <div
                            class="w-full border-[2px] border-black px-4 bg-[#fffbf1] shadow-[8px_8px_0px_0px_#0073e6] flex justify-between items-center h-[60px] focus-within:ring-2 focus-within:ring-[#0073e6] transition-shadow">
                            <input type="text" v-model="form.nom"
                                class="flex-1 bg-transparent focus:outline-none w-full" />
                    ...
                    <div class="flex-1 flex flex-col gap-2">
                        ...
                        <div
                            class="w-full border-[2px] border-black px-4 bg-[#fffbf1] shadow-[8px_8px_0px_0px_#0073e6] flex justify-between items-center h-[60px] focus-within:ring-2 focus-within:ring-[#0073e6] transition-shadow">
                            <input type="text" v-model="form.employes"
                                class="flex-1 bg-transparent focus:outline-none w-full" />
                            <span class="text-red-500 font-bold ml-2 flex-shrink-0">*</span>
                        </div>
                ...
                <div class="flex flex-col md:flex-row gap-6 md:gap-12">
                    ...
                    <div class="flex-1 flex flex-col gap-2">
                        ...
                        <div
                            :class="['w-full border-[2px] px-4 shadow-[8px_8px_0px_0px_#0073e6] flex justify-between items-center h-[60px] transition-colors',
                            ...
                            <input type="email" v-model="form.mail" @input="validateEmail"
                                class="flex-1 bg-transparent focus:outline-none w-full" />
                            <span class="font-bold ml-2 flex-shrink-0"
                                :class="showEmailError ? 'text-[#e62b1d]' : 'text-red-500'">*</span>
                        </div>
                        <span v-if="showEmailError" class="text-xs text-[#e62b1d] mt-1">Veuillez entrer un mail
                            valide.</span>
                    </div>
                ...
                <div class="flex flex-col gap-2 mb-4">
                    ...
                    <div
                        class="w-full border-[2px] border-black px-4 bg-[#fffbf1] shadow-[8px_8px_0px_0px_#0073e6] flex justify-between items-center h-[60px] focus-within:ring-2 focus-within:ring-[#0073e6] transition-shadow">
                        <input type="text" v-model="form.message" placeholder="Vos questions ou précisions"
                            class="flex-1 bg-transparent focus:outline-none w-full placeholder-gray-400" />
                    </div>
                ...
                <!-- Submit Button -->
                <div>
                    <button type="submit" :disabled="!isFormValid" :class="['font-[\'Jersey_20\'] tracking-wide px-20 py-4 transition-colors text-black text-2xl border-[2px] border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] w-full md:w-auto min-w-[350px]',
